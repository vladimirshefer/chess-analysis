    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="prose prose-indigo text-gray-600">
          <p className="mb-4">
            This is a full-stack chess analysis and replay tool designed to help
            you review games quickly. By importing a PGN (Portable Game
            Notation) string, you can step through moves, jump to specific
            positions, and visualize the game flow.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-8">
            ...
            <li>
              Navigation: Keyboard-friendly (coming soon) and UI-based playback
              controls.
            </li>
