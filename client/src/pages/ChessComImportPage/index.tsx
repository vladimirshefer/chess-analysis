...
import {type ChessComGameSummary, type ChessComRecentGames, getRecentGames} from "../../lib/chessCom.ts";
...
function ChessComImportPage() {
    ...
    const [gamesResult, setGamesResult] = useState<ChessComRecentGames | null>(
        null,
    );
