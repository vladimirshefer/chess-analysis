...
function ChessComImportPage() {
  ...
  const [gamesResult, setGamesResult] = useState<ChessComRecentGames | null>(null);
    ...
    <div className="max-w-5xl mx-auto flex flex-col gap-6">
      <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
        <div className="flex items-center justify-between gap-4 mb-4">
          ...
          <Link to="/" className="text-sm font-bold text-indigo-600 hover:underline">Back to analyzer</Link>
        </div>
      ...
      {gamesResult && (
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
          <div className="mb-4">
            ...
            <a href={gamesResult.player.url} target="_blank" rel="noreferrer" className="text-xs text-indigo-600 hover:underline">
                ...
                <div key={game.id} className="border border-gray-200 rounded-lg p-4 bg-gray-50 flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    <div className="bg-white border border-gray-200 rounded p-3">
                      ...
                      <div className="text-gray-600">{game.white.username}{typeof game.white.rating === 'number' ? ` (${game.white.rating})` : ''}</div>
                    ...
                    <div className="bg-white border border-gray-200 rounded p-3">
                      ...
                      <div className="text-gray-600">{game.black.username}{typeof game.black.rating === 'number' ? ` (${game.black.rating})` : ''}</div>
